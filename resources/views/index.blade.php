...
@section('content')
    ...
    <section id="hero" class="hero">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10">
            <h2 data-aos="fade-up" data-aos-delay="100"> Explore the pinnacle of IT solutions with us</h2>
            <p data-aos="fade-up" data-aos-delay="200">Delivering top-notch IT solutions and services, we empower businesses with cutting-edge technology, ensuring growth, efficiency, and innovation.</p>
          </div>
          <!-- <div class="col-lg-5">
